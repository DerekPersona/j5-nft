...
(function ($) {
  ...
  if (window.matchMedia('(min-width: 769px)').matches) {
    ...
    if ($('.section-hero').length) {
      $('.section-description__image').mousemove(function (e) {
        let elemOffset = $(this).offset();
        let x = e.pageX - elemOffset.left;
        let y = e.pageY - elemOffset.top;

        $(this)
          .find('.section-description__image-img--1')
          .css({
            transform:
              'translate3d(' +
              x * 0.05 +
        ...
        $(this)
          .find('.section-description__image-img--2')
          .css({
            transform:
              'translate3d(' +
              x * 0.1 +
        ...
        $(this)
          .find('.section-description__image-img--3')
          .css({
            transform:
              'translate3d(' +
              x * -0.07 +
        ...
        $(this)
          .find('.section-description__image-img--4')
          .css({
            transform:
              'translate3d(' +
              x * -0.13 +
        ...
        $(this)
          .find('.section-description__image-img--5')
          .css({
            transform:
              'translate3d(' +
              x * 0.1 +
      ...
      $('.section-description__image').mouseout(function (e) {
        $(this).find('.section-description__image-img').css({
          transform:
            'translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)',
